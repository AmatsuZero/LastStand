...
draft = true
weight = 12
tags = ["面试", "前端", "ES6", "JavaScript", "Map与Set", "ecool"]
categories = ["前端开发", "面试"]
source = "https://fe.ecool.fun/knowledge-learn"
+++
每当去学习ES6的时候，我都会不由自主的打开阮一峰老师的[《ES6入门》](http://es6.ruanyifeng.com/#docs/set-map)去学习和查找用法，相信大多数同学也都和我一样看过阮老师写的文章。
...
在 ES6 中，`Map` 和 `Set` 是两种新的数据结构，用来弥补对象和数组在“键值存储”和“去重”上的一些不足。它们在**性能、数据结构选择、API 灵活性**等方面提供了更强的能力。
