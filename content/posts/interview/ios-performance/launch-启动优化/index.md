...
> 启动监控是 APM 的重要子系，线上 P50/P90/P99 的采集、冷/温/热启动判定、以及与业务秒开指标的关联，请参考 [APM 系列](../APM/APM.md)：[指标体系](../APM/APM-指标体系.md)、[数据采集](../APM/APM-数据采集.md)。

---

## 启动流程概述

[App的启动流程](../../ios-basics/App启动流程.md)分为两个主要阶段：
...
- [启动优化-Rebase与Bind](./启动优化-Rebase与Bind.md)
  - Rebase/Bind 的基本原理
  - 减少ObjC类数量
  - 减少Category使用
  - 减少C++虚函数
...
- [启动优化-Initializers](./启动优化-Initializers.md)
  - C++静态构造函数的影响
  - 延迟初始化
  - 使用Swift懒加载
  - 移除不必要的constructor函数
...
- [启动优化-didFinishLaunching](./启动优化-didFinishLaunching.md)
  - 分级启动任务管理
  - 并行初始化
  - 使用RunLoop空闲时机
  - 任务依赖关系处理
