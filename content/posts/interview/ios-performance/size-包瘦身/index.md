...
iOS 13开始，Apple取消了`__TEXT`段加密，下载体积自然更小。针对iOS 13之前版本的优化手段（段迁移）详见[可执行文件优化]({{< relref "/posts/interview/ios-performance/size-可执行文件优化" >}})。
...
- [包瘦身-分析工具]({{< relref "/posts/interview/ios-performance/size-分析工具" >}})
  - 查看IPA构成
  - LinkMap分析
...
- [包瘦身-可执行文件优化]({{< relref "/posts/interview/ios-performance/size-可执行文件优化" >}})
...
- [包瘦身-资源优化]({{< relref "/posts/interview/ios-performance/size-资源优化" >}})
...
- [包瘦身-App Thinning]({{< relref "/posts/interview/ios-performance/size-AppThinning" >}})
  - Slicing原理
  - Bitcode（已废弃）
  - On-Demand Resources
