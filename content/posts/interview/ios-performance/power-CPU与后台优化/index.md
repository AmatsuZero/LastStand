...
根据 [耗电-原理]({{< relref "/posts/interview/ios-performance/power-原理" >}}) 中的分析，CPU耗电由三部分构成：
...
参见 [耗电-定位与传感器优化]({{< relref "/posts/interview/ios-performance/power-定位与传感器优化" >}}) 中的详细讲解。简单原则：
...
接下来进入 [耗电-网络优化]({{< relref "/posts/interview/ios-performance/power-网络优化" >}})，看看网络请求如何影响耗电。
