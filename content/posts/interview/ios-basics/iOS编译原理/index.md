...
关于 Swift 编译流程和 SIL 的详细内容，参见 [SIL]({{< relref "/posts/interview/ios-basics/SIL" >}})。
...
关于 Mach-O 文件格式和链接的详细内容，参见 [Mach-O的链接、装载与库]({{< relref "/posts/interview/ios-basics/Mach-O的链接-装载与库" >}})。
...
关于 SIL 和 Swift 编译流程各阶段的详细内容，参见 [SIL]({{< relref "/posts/interview/ios-basics/SIL" >}})。
...
关于 Clang Module 和 PCH 的详细对比，参见 [Objective-C中import详解]({{< relref "/posts/interview/ios-basics/Objective-C中import详解" >}})。
...
关于 WMO 的更多细节和 SIL 层面的优化，参见 [SIL]({{< relref "/posts/interview/ios-basics/SIL" >}})。
...
关于 Swift 二进制兼容性和 Library Evolution 的详细内容，参见 [Swift二进制兼容性]({{< relref "/posts/interview/ios-basics/Swift二进制兼容性" >}})。
...
关于二进制重排的更多实践细节，参见 [启动优化-二进制重排]({{< relref "/posts/interview/ios-performance/launch-二进制重排" >}})。
