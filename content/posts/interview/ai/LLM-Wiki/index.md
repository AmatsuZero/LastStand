...
大多数人今天使用 LLM 处理文档的方式是 [RAG（检索增强生成）]({{< relref "/posts/interview/ai/RAG" >}})：
...
- **本站相关**：[RAG（检索增强生成）]({{< relref "/posts/interview/ai/RAG" >}})、[AI Agent]({{< relref "/posts/interview/ai/AI-Agent" >}})、[AI编程工具]({{< relref "/posts/interview/ai/AI编程工具" >}})
