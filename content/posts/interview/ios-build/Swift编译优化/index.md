...
配合 [编译优化-观测]({{< relref "/posts/interview/ios-build/观测" >}}) 中的参数，开启：
...
CMO 通常只在 Release 开启，并要配合 [编译优化-二进制化]({{< relref "/posts/interview/ios-build/二进制化" >}}) 一起评估。
...
更多可见 [Swift宏]({{< relref "/posts/interview/ios-basics/Swift宏" >}})。
