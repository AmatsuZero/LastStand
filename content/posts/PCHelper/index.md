...
<div style="border:1px solid #334155;border-radius:12px;padding:14px 16px;background:rgba(15,23,42,0.35);margin:12px 0;color:#e2e8f0;">
  <div style="font-weight:700;font-size:15px;margin-bottom:10px;color:#e2e8f0;">PC 开播助手（Electron）</div>
...
<div style="border:1px solid #334155;border-radius:12px;padding:14px 16px;background:rgba(15,23,42,0.35);margin:12px 0;color:#e2e8f0;">
  <div style="font-weight:700;font-size:15px;margin-bottom:10px;color:#e2e8f0;">多房间架构（SubRoom）</div>
...
<div style="border:1px solid #334155;border-radius:12px;padding:14px 16px;background:rgba(15,23,42,0.35);margin:12px 0;color:#e2e8f0;">
  <div style="font-weight:700;font-size:15px;margin-bottom:10px;color:#e2e8f0;">OBS Node 推流流程</div>
...
<div style="border:1px solid #334155;border-radius:12px;padding:14px 16px;background:rgba(15,23,42,0.35);margin:12px 0;color:#e2e8f0;">
  <div style="font-weight:700;font-size:15px;margin-bottom:10px;color:#e2e8f0;">RTMP / TRTC 复用推流入口</div>
  <div style="display:flex;flex-wrap:wrap;align-items:center;gap:8px;margin-bottom:8px;">
...
<div style="border:1px solid #334155;border-radius:12px;padding:14px 16px;background:rgba(15,23,42,0.35);margin:12px 0;color:#e2e8f0;">
  <div style="font-weight:700;font-size:15px;margin-bottom:10px;color:#e2e8f0;">陪看核心流程（时序）</div>
...
<div style="border:1px solid #334155;border-radius:12px;padding:14px 16px;background:rgba(15,23,42,0.35);margin:12px 0;color:#e2e8f0;">
  <div style="font-weight:700;font-size:15px;margin-bottom:10px;color:#e2e8f0;">SEI 状态同步链路</div>
  <div style="display:flex;flex-wrap:wrap;align-items:center;gap:8px;line-height:1.8;">
...
<div style="border:1px solid #334155;border-radius:12px;padding:14px 16px;background:rgba(15,23,42,0.35);margin:12px 0;color:#e2e8f0;">
  <div style="font-weight:700;font-size:15px;margin-bottom:10px;color:#e2e8f0;">零拷贝渲染链路</div>
  <div style="display:flex;flex-wrap:wrap;align-items:center;gap:8px;line-height:1.8;">
