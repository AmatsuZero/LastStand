...
draft = false
weight = 9
tags = ["面试", "前端", "计算机网络", "正向代理和反向代理", "ecool"]
categories = ["计算机基础", "面试"]
...
##### 3.2 反向代理
 ...
 假设用户A访问 **[www.somesite.com/something.html**，但](http://www.somesite.com/something.html**%EF%BC%8C%E4%BD%86) [www.somesite.com](http://www.somesite.com/) 上并不存在something.html页面，于是接收用户请求的该服务器就偷偷从另外一台服务器上取回来，然后返回给用户，而用户并不知道something.html页面究竟位于哪台机器上。
...
“正向代理”和“反向代理”是前端与网络交叉领域的高频考察点，涉及**网络请求过程、安全控制、架构设计、前端跨域处理**等多个方面。
