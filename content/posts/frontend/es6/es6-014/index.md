...
draft = false
weight = 14
tags = ["面试", "前端", "ES6", "JavaScript", "defineProperty 与 proxy", "ecool"]
categories = ["前端开发", "面试"]
...
在 JavaScript 中，`Object.defineProperty` 和 `Proxy` 都可以实现对象属性的劫持，是实现响应式、封装权限、拦截行为等核心技术的基础。面试中通常会从它们的**能力、区别、使用场景、性能、限制**等方面进行考察，特别是在 Vue2 和 Vue3 响应式原理对比时尤为重要。
