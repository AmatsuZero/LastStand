...
title = "AI相关 面试题"
draft = false
tags = ["面试", "前端", "AI相关", "ecool"]
categories = ["前端开发", "面试"]
source = "https://fe.ecool.fun/topic-list"
generatedAt = "2026-08-01T05:15:56.564Z"
+++

共 43 道 AI相关 面试题。答案默认折叠，便于先自行作答。

## 1. 如何实现 ChatGPT 类似的流式输出？ {#question-f58b9f85-153d-47b9-851f-f65abe8ec3e0}
...
## 2. Vibe Coding 与 Spec Coding 有什么区别？ {#question-a65fb630-3570-43ff-ac3a-cf92d51ce101}
...
## 3. Prompt Injection 是什么？ {#question-9f97d4b9-0aba-4612-ae34-0e23242aed0c}
...
## 4. MCP 为什么被认为是 AI 时代的 USB-C？ {#question-af2347d8-ab53-4882-848b-dfa3ff264ec5}
...
## 5. MCP 如何实现权限控制？ {#question-e775a01a-df14-4ec2-9e0c-935d8602c8e4}
...
## 6. MCP 如何实现工具发现（Discovery）？ {#question-cd88942e-62a5-4ff5-9392-cd3f39ceaf29}
...
## 7. MCP 与 Function Calling 的关系是什么？ {#question-d33aadbf-d49d-439e-9cde-bd64b9349c89}
...
## 8. MCP 的通信流程是什么？ {#question-f224392f-4821-42b0-b143-30fc5a07bff9}
...
## 9. MCP Client 与 MCP Server 的职责分别是什么？ {#question-1330a35d-f8c5-4a61-9363-735381f1a155}
...
## 10. MCP 的核心价值是什么？ {#question-634ebf30-1fee-4dd9-afb1-b376faa977c6}
...
## 11. 什么是 MCP？ {#question-36aaf63e-ff27-44df-b9bb-73a568d0e77f}
...
## 12. 说说Agent应用的优缺点？ {#question-df9c8647-4fda-465d-9d16-53c9b45b71f0}
...
## 13. Vibe Coding 和 Spec Coding 分别是什么？ {#question-2d2e3dd9-dcce-47d8-8319-31734155184b}
...
## 14. 如果公司想用大模型，但又担心暴露隐私数据，该怎么解决？ {#question-46bf3a82-865f-4391-8ff9-1e5b5658f6be}
...
## 15. 大模型的计费规则一般会区分“输入（命中缓存）”、“输入（未命中缓存）”、“输出”，它们有什么区别？ {#question-7396ddf6-52d8-4f27-94f4-27e04d7cc15b}
...
## 16. 各种大模型场景给出的 Coding plan 套餐中，Tokens 和 Credits 分别是什么？ {#question-46a530de-db64-4561-a680-591146f61c2c}
...
## 17. 有了解 AI 的使用和一些前沿概念吗 {#question-3c9f71bc-412f-45e6-8fc3-7ff2d3363d73}
...
## 18. claude 中的 skills 和 mcp 有什么区别？ {#question-0616c661-6289-4479-adc6-8f4231562649}
...
## 19. 如何利用AI辅助进行前端性能优化 {#question-fa2cc5b6-01c7-4e34-bc61-d857e936d5d3}
...
## 20. 如果让你设计一个支持AI功能（如智能对话）的前端应用架构，你会考虑哪些方面？ {#question-0b920560-239f-41d7-9f61-530b5b0d5903}
...
## 21. 谈谈你遇到过AI生成代码的Bug，以及如何解决的。 {#question-5a30098c-581e-4fea-873d-89e02a806c63}
...
## 22. 写一个 prompt，让AI手写一个符合Promise A+规范的Promise {#question-47d54e6d-036f-4125-854a-f56057f82d24}
...
## 23. 在 AI 可以自动生成 80% 基础代码的今天，你认为前端工程师的核心价值在于哪里？ {#question-32797895-a944-4341-88ae-7cde47215472}
...
## 24. 如何优化前端AI模型的推理性能，避免界面卡顿？ {#question-d36508b8-52dc-4343-9f2a-e7d1f8b96230}
...
## 25. 如何保证AI生成代码的质量和符合项目规范？ {#question-033485ae-8462-4f62-853a-d211617b9038}
...
## 26. 你平时使用哪些AI编程工具？ {#question-7e3f91e5-3360-4d75-b88f-bf37d18d4025}
...
## 27. Prompt 是什么，比如要实现一个搜索表单页面，你会用什么样的 Prompt？ {#question-a985899b-4460-4e46-83ab-682b717f7bad}
...
## 28. 大家常提到的 Transformer 架构是什么？ {#question-8c620489-aef2-47be-b9c2-ba95bb48bf3d}
...
## 29. 你清楚 AI、AGI、AIGC、NLP、LLM 分别是什么吗？ {#question-57b9e47a-11b0-489a-a654-e56a6ed7f0fa}
...
## 30. AI 工具中，经常提到的 mcp 是什么，有哪些与前端方向结合的场景？ {#question-ab91b1c8-b017-488d-9d69-45ca69b012e7}
...
## 31. 请设计一个面向设计师的“AI 助手”前端界面，可以生成文本、图像并自动插入到设计稿中 {#question-fc324e39-07c5-404f-9489-d9f0900d8988}
...
## 32. 如何保障前端调用 AI 接口时的安全性与权限控制？你是否考虑过代理服务或签名机制？ {#question-4b86cad9-a1a7-42d9-9ac0-5fe039ab7957}

> 难度：3.5 · 类型：QA

### 题目要点

- **必选方案**：代理服务隐藏真实接口 + 动态签名替代静态密钥<br>
- **推荐组合**：JWT 用户认证 + HMAC 服务间认证 + 输入/输出过滤<br>
- **高阶防护**：私有链路接入 + 本地内容审查模型<br>
...
![image](https://static.ecool.fun/others/868a5cb3-8693-40b7-aaa5-ba2a1a54a391.png)
  ...
  - **优势**：隐藏真实 endpoint、屏蔽 API Key<br>
...
#### 3. **敏感数据泄露**
- **最小化权限原则**<br>
  - 使用 AI 厂商的临时令牌（如 AWS STS Token）<br>
...
#### 3. **审计与监控**
- **日志记录**：存储所有 AI 请求的元数据（用户 ID、时间、消耗 token 数）<br>
...
### 四、架构选型建议
1. **Serverless 代理**<br>
   - 使用 Cloudflare Workers/AWS Lambda 实现无服务器代理<br>
   - 优点：自动扩展、边缘节点缓存
...
## 33. 假设要做一个 AI 语音生成工具（TTS），如何处理音频播放、缓存与断点续播？ {#question-34c5397b-4818-4bfe-bbcb-9ead801ad56b}

> 难度：3.5 · 类型：QA

### 题目要点

- **播放层**：优先使用 Web Audio API 实现精细控制，兼容 `<audio>` 兜底<br>
- **缓存层**：内存+磁盘+服务端三级缓存，LRU 控制存储容量<br>
- **续播层**：持久化播放状态 + 时间戳同步 + 块队列管理<br>
- **健壮性**：网络中断恢复 + 解码错误降级 + 离线支持<br>
- **性能**：并行解码 + 智能预加载 + 内存回收
...
### 五、性能优化技巧
1. **并行解码**：使用 Web Worker 提前解码后续音频块<br>
2. **预加载策略**：根据用户行为预测加载可能需要的语音（如翻页时预载下一页内容）<br>
3. **内存管理**：释放非活跃音频块的 Web Audio 节点，避免内存泄漏<br>

实际开发中建议结合 WebRTC 的 `insertable streams` 处理实时流，并考虑添加 WASM 加速的音频处理模块。对于企业级应用，可引入音频指纹水印技术防止内容滥用。

</details>

## 34. 如何封装一个 AI 图片生成组件，支持选择模型、输入 prompt、展示图像并支持本地保存？ {#question-e252d8f2-de0c-43a7-9799-06e965b08b61}
...
## 35. 如何在富文本中插入可控组件，如“可编辑 AI 卡片”、“模型输入块”等？会有哪些技术难点？ {#question-78f49ef0-e977-4d4c-a11b-d98cef343236}
...
## 36. 如何基于现有富文本编辑器（如 Slate、TipTap、Monaco）扩展支持 AIGC 插件？比如一键生成段落或续写？ {#question-e8fdf26b-2148-4954-bcc8-908423e2eeed}
...
## 37. 当前主流大模型 API（如 OpenAI、Claude、文心一言）在前端调用时需要注意哪些问题？如何做统一封装？ {#question-3d7b1143-c6c2-4444-8bf5-ebe4c6766a6b}
...
## 38. 你知道什么是 AIGC 吗，是否有参与过相关工具的研发？ {#question-c7c51194-cef4-4d20-bafd-88d5d1ac2921}
...
## 39. 请设计一个能自动生成产品文案的前端小工具，简述如何设计 UI ，以及与后端 AI 服务的交互流程。 {#question-14755ea5-6a95-4a6f-b9e7-152df5f188f3}
...
## 40. 你了解哪些 AI 前端工具或库？ {#question-6ccec2ec-93df-48af-b4f0-24fd77749b60}
...
## 41. 如何在前端安全地使用大语言模型 API，比如调用 OpenAI 接口进行文本生成？ {#question-1bae32bb-a56f-41e7-975f-2c6997d64d29}
...
## 42. 假如要做一个类似 ChatGPT 的聊天 UI，前端如何处理流式响应？ {#question-4c58e87a-222a-458c-aab8-fd0c16580594}
...
## 43. 如何在前端项目中集成 AI 能力，例如实现智能对话、图像识别或推荐系统？ {#question-3ea6f42d-50f6-4b3f-9f44-1bdf7c886a13}
