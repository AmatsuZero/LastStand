...
title = "小程序 面试题"
draft = false
tags = ["面试", "前端", "小程序", "ecool"]
categories = ["前端开发", "面试"]
source = "https://fe.ecool.fun/topic-list"
generatedAt = "2026-08-01T04:29:37.564Z"
+++

共 15 道 小程序 面试题。答案默认折叠，便于先自行作答。

## 1. 小程序可以做哪些性能优化？ {#question-92e09b66-a9fc-435d-ad28-99011b2ddeaa}
...
## 2. 小程序的页面加载流程是怎样的？请简要描述从用户点击小程序图标到页面显示的整个过程。 {#question-35e4a8d7-248e-429c-b590-da73408f3d37}
...
## 3. 分析微信小程序和微信内的 H5 网页在性能上的区别，以及导致这些区别的原因是什么？ {#question-d3513abc-7499-4cb3-8d51-864ffc022c9e}
...
## 4. 小程序如何实现rpx到px的转换？如何适配不同屏幕密度的设备（如Retina屏）？ {#question-4e5f6035-c1a8-48b1-a561-e2d4710e3698}
...
## 5. 怎么处理微信小程序里的静默授权异步问题？ {#question-d4932c0d-8a08-4b1b-9e52-036572452c9f}
...
## 6. 为什么小程序中无法使用 dom 相关的 api？ {#question-015d6008-c1c2-4b86-8db3-e3baa1ff0327}
...
## 7. 为什么小程序里拿不到dom相关的api？ {#question-be1dfffb-1f1b-43b1-9223-4a57efd1d978}
...
## 8. 小程序的双线程分别做的什么事情？ {#question-b7083fff-b5d6-4767-a25b-e4b9b18229bb}
...
## 9. 说说微信小程序的架构? {#question-9e7a00c3-a299-487c-92b0-19cf80db1f45}
...
## 10. 简述微信小程序原理？ {#question-887a5434-989a-45c3-bf97-b6988394ece6}
...
## 11. 微信小程序的优劣势？ {#question-1464793e-3ece-4943-92af-cb470fee46f3}
...
## 12. 小程序页面间有哪些传递数据的方法？ {#question-92af3054-e90c-4c0d-a5af-2a54b19931ab}
...
## 13. 微信小程序bindtap  和  catchtap 区别？ {#question-17b59078-ccef-4190-9282-60805ddf6b3f}
...
## 14. 小程序 WXSS  与 CSS 的区别？ {#question-7f816cdc-b5e8-4939-9c85-004a4110210c}
...
## 15. 简述一下微信小程序的主要文件有哪些？ {#question-66ee2368-475e-403c-afb2-2c3fd693a843}
