...
title = "场景题 面试题"
draft = false
tags = ["面试", "前端", "场景题", "ecool"]
categories = ["前端开发", "面试"]
source = "https://fe.ecool.fun/topic-list"
generatedAt = "2026-08-01T05:15:50.021Z"
+++

共 84 道 场景题 面试题。答案默认折叠，便于先自行作答。

## 1. 现在大模型已经能高效生成界面代码，有人认为前端会被AI颠覆，也有人认为这只是工具革新。你更倾向哪种观点？你认为前端未来3-5年真正的机会点或转型方向是什么？ {#question-58605bf6-530e-4b56-973a-a0147b3e3f7e}
...
## 2. 项目中是否有必要自己封装请求库？ {#question-76bd6235-2d8d-4519-b14a-98bbde4eb3a1}
...
## 3. 如果在项目中需要使用到动态表单，你会怎么实现？ {#question-6e229410-c489-4f7f-bcc1-36ffc38d0eb5}
...
## 4. 如果页面含 100 个第三方资源，你会如何处理？ {#question-8102159f-f373-4b08-8597-7220e4afc36c}
...
## 5. 在前端项目中，如何设计前端与后端的数据交互机制？请说明数据传输格式、接口设计原则以及如何优化性能。 {#question-ad2e4aae-8548-476f-82cb-6960ed6b2b5c}
...
## 6. 在即时通讯场景中，在同步消息时，如果出现网络延迟或部分设备未在线，你会如何确保消息的最终一致性？ {#question-3bfb36e7-3255-4166-813e-7a54d05a2f65}
...
## 7. 开发一个即时通讯系统的前端页面时，你会如何设计消息的存储和同步机制？如何处理用户切换设备后的消息同步问题？ {#question-7225b3f6-48f1-48ea-aaf3-45cc9a1b8813}
...
## 8. 有一个需要支持10万条数据渲染的表格组件，你会如何设计和优化？ {#question-93ace4ab-cf3b-44ce-a51e-be4e51bd7157}
...
## 9. 如果需要做图片懒加载，并且图片数量很多，你会怎么做呢？ {#question-8b689a20-951d-4e11-a5de-0d66e6fa108a}
...
## 10. 怎么根据当前滚动位置，实现目录中对应节点自动高亮？ {#question-87822042-2e08-4f8d-915c-941541d0158d}
...
## 11. 如果需要完成一个协同文档的系统，你会如何进行架构设计呢 {#question-e4e723c1-b069-4500-8a3d-3d6866e00c9d}
...
## 12. 平常你是如何进行代码调试的？ {#question-1044b4d4-a095-4730-b911-8426b8667baf}
...
## 13. 多个项目共用组件时，如何保证版本一致性？ {#question-83e26176-c58a-4015-80c8-a10093243af7}
...
## 14. 当需要更改组件库中组件的主题时，有哪些常见的方法？请以你熟悉的组件库为例，说明如何实现主题定制。 {#question-c878d3c2-0ca2-4738-a945-ddbaba9945a6}
...
## 15. 如果你有一个业务组件库，希望打包输出为 esm + cjs + dts，有什么思路？ {#question-35996816-36ac-45ba-ae5e-8bebbede73d1}
...
## 16. 前端实现的倒计时为什么会有误差？有什么减小误差的解决方案吗？ {#question-b178d461-b38f-4415-8f26-d9126b5e167d}
...
## 17. 对于 PC 端的 banner 组件，你会怎么适配超宽的屏幕？ {#question-96b19a65-3d26-43eb-ba9c-5cb4754dffc6}

> 难度：1.5 · 类型：QA

### 题目要点

- 内容区域设置 `max-width` 居中是关键<br>
- 背景使用 cover/拉伸延展增强视觉体验<br>
...
## 18. ChatGPT 的对话功能实现，为什么选择 SSE 协议而非 Websocket ？ {#question-3dd31a51-615f-46b6-8fd4-244f579ac16c}
...
## 19. 有一个新的前端项目需要部署到线上，你有什么思路？ {#question-e0bdad20-aa88-44d9-a9aa-c0bb90100ac9}
...
## 20. 怎么在 react 技术栈的低代码平台中，实现组件的脚本注入？ {#question-bb716003-6366-45be-861e-df4f68f748fd}
...
## 21. 怎么实现表单项间的联动？ {#question-fcc981b9-4770-402a-a1cf-c838a252420a}
...
## 22. 现在要开发一个响应式的网站，怎么实现根据设备的尺寸和分辨率，加载不同尺寸的 banner？要求不使用 JavaScript {#question-d95319f5-e060-4727-a7a4-d4996c00a6c7}
...
## 23. 如果想在小程序中嵌入 markdown 的文档，你有什么思路？ {#question-d687d4df-669d-46a1-a037-d84d8c819bfe}
...
## 24. 假如让你负责一个商城系统的开发，现在需要统计商品的点击量，你有什么样设计与实现的思路？ {#question-9ccba9eb-a2fe-4334-8c82-bf6fa2582cab}
...
## 25. 前端如何实现即时通讯？ {#question-b0b29463-196e-433f-a727-3bf26ea622c9}
...
## 26. 前端怎么做错误监控？ {#question-fac9701b-e86e-499a-b1eb-8ba6a79dd146}
...
## 27. 如何给自己团队的大型前端项目设计单元测试？ {#question-596d0fe1-6817-45d9-94f6-5ea4104c818d}
...
## 28. 如何做一个前端项目工程的自动化部署，有哪些规范和流程设计？ {#question-030b9bad-6476-469a-896a-866596754c08}
...
## 29. 怎么分析页面加载慢的原因？ {#question-f9dc6afe-f0e3-4f13-904a-91e32dac0cbb}
...
## 30. 如何监控前端页面的崩溃？ {#question-afa95f31-3fde-4017-b247-c901df3c8fc9}
...
## 31. 实现 table header 吸顶， 有哪些实现方式？ {#question-3c436b0a-3f53-4b66-a5cf-3ce6aef339c8}
...
## 32. 前端单页应用 History 路由模式， 需要如何配置 nginx？ {#question-360dfbe1-ae7c-4b59-8774-9a93be4bf01e}
...
## 33. 前端如何实现截图？ {#question-08d4f63d-6d32-4a94-be36-75aa55e09730}
...
## 34. Redux 和 Vuex 的设计思想是什么？ {#question-14bf5712-b28f-41a0-852f-af40a342afde}
...
## 35. 怎么实现同一个链接，PC 访问是 web 应用，而手机打开是一个 H5 应用？ {#question-adefec84-bbf1-4d1e-995f-cc5b75638e43}
...
## 36. 如何在前端团队快速落地代码规范 {#question-3e97e4b8-dda4-4e5b-8fd9-136fe1e95eb4}
...
## 37. react 中怎么实现下拉菜单场景，要求点击区域外能关闭下拉组件 {#question-6576edd9-ceb6-4871-8e33-008fdad7ef80}
...
## 38. 如何解决 node_modules 中，同一个包安装了多个不同版本的问题？ {#question-5ea871ee-7242-4aa3-9684-bb5ac3be2bed}
...
## 39. 如何解决页面请求接口大规模并发问题 {#question-6230fdac-bad1-4a20-aca7-69b7ce01ca25}
...
## 40. 如何设计一套统计全站请求耗时的工具 {#question-d158ac72-5f69-434b-a00c-c7976efe8781}
...
## 41. 如果用户说 web 应用感觉很反应慢或者卡顿，该如何排查？ {#question-5926a5ad-e62b-42c7-a747-676ca6c0ad57}
...
## 42. 站点一键换肤的实现方式有哪些？ {#question-10f7d3d8-9639-4b55-91b0-d3569abd7faa}
...
## 43. 说说你对 package.json 中配置项的了解 {#question-997b836f-1a8c-4aa1-9676-aa923c9533d5}
...
## 44. 怎么实现扫码登录？ {#question-288b6f85-3e2d-4c05-a145-d463ead8a4dd}
...
## 45. 怎么在前端页面中添加水印？ {#question-98bc1edf-2899-40cb-a2b2-93e053024218}
...
## 46. 如何将JavaScript代码解析成抽象语法树(AST)？ {#question-f1e53d83-934a-4c82-b9de-67ca962967e1}
...
## 47. token过期后，页面如何实现无感刷新？ {#question-352f435e-413f-4a47-9651-f08ed2bd6071}
...
## 48. web 应用中如何对静态资源加载失败的场景做降级处理？ {#question-893f6941-8eb4-4c4c-9bba-0f4802d7320a}
...
## 49. 如何搭建一套灰度系统？ {#question-0a0d4005-feca-46c9-9a69-6757f231a032}
...
## 50. 前端项目里，一般对请求 request 做哪些统一的封装？ {#question-2b8e3ddf-b8cb-464b-8af4-0efed5b911b0}
...
## 51. 如何封装一个请求，让其多次调用的时候，实际只发起一个请求的时候，返回同一份结果？ {#question-e902d336-e2dd-4de7-a471-16806c695aa9}
...
## 52. 你参与过哪些前端基建方面的建设？ {#question-cd57a5aa-c239-4cb2-b2b5-d0d6a49f80f3}
...
## 53. web 网页如何禁止别人移除水印 {#question-2dfa4a7b-6267-485f-9600-312a47ffedc8}
...
## 54. 你是怎么理解前端架构的？ {#question-ea1da4c7-c61e-4fc7-ba82-cf92277f8bdf}
...
## 55. 用户访问页面白屏了， 原因是啥， 如何排查？ {#question-5a7dd073-22ba-4081-94a2-51635c94f3c6}
...
## 56. SPA首屏加载速度慢的怎么解决 {#question-5cb71435-19b4-45ef-bcee-f2d9825af25e}
...
## 57. React 如何实现 vue 中 keep-alive 的功能？ {#question-41d27d78-a7fd-4c87-a1a4-99a96d7dedb9}
...
## 58. 怎么使用 webpack，将 JS 文件中的 css 提取到单独的样式文件中？ {#question-48251068-35a0-4698-b7bd-2836e1222264}
...
## 59. 为什么在技术选型中选择了 webpack？ {#question-3b556627-805c-44e0-b70f-a309666281ab}
...
## 60. 如果公司要做一个低代码平台，你会怎么进行架构设计？ {#question-78fae9ee-ae6b-47e5-97b8-355843db954b}
...
## 61. 低代码平台的页面数据结构该怎么设计？ {#question-8a2224d7-903d-4c9a-adbe-3547a824c87f}
...
## 62. 低代码平台怎么设计渲染模块？ {#question-47c74fea-f648-402a-b542-8167d5194b5c}
...
## 63. 在前端应用中，怎么进行系统权限的设计？ {#question-431ed9b6-fb2d-47a9-966d-77e8b771492a}
...
## 64. 如果让你实现一个前端日志埋点 SDK，你会有什么样的设计思路？ {#question-c2b65646-1817-4fcf-8ac5-f98f4fa2d184}
...
## 65. 在项目中封装组件时，你会有些什么样的原则？ {#question-0ee642b5-d48b-4295-850f-f96a933b4910}
...
## 66. 前端系统中，怎么统一处理登录态过期的场景？ {#question-3d4e5433-6d67-4a4c-8cc5-85257807d775}
...
## 67. 常见的登录鉴权方式有哪些？ {#question-2a6a5b54-6c0f-4b6e-b767-92b6d30ebb2b}
...
## 68. 如果需要使用 JS 执行 100 万个任务，如何保证浏览器不卡顿？ {#question-fb13c516-f611-42db-9b72-27d9730be3b6}
...
## 69. 对于分页的列表，怎么解决快速翻页场景下的竞态问题？ {#question-05964151-1414-425a-b3a0-43cce2c45348}
...
## 70. 如何检测网页空闲状态（即一定时间内无操作）？ {#question-5b879336-0a8e-4a86-abd3-76d546dd3455}
...
## 71. 前端应用上线后，怎么通知用户刷新当前页面？ {#question-f815f550-10a2-4666-8889-b5481b2f549c}
...
## 72. 如何从 0 到 1 搭建前端基建？ {#question-a4b0af6f-1cdc-4f39-96b3-469441026c19}
...
## 73. 在表单校验场景中， 如何实现页面视口滚动到报错的位置 {#question-0cd28c90-bcfa-43ef-831d-5af7182b2abe}
...
## 74. 前端渲染和后端渲染分别有什么优缺点， 为什么现在的技术大方向，又逐渐往“后端渲染”方向靠了呢？ {#question-94f8e420-ec2b-43ce-acb1-8b854381e6bb}
...
## 75. 如果你有一个内容站点，怎么防止其他人爬虫？ {#question-e4dffed7-86ad-4ffe-9878-aa8321ccfeef}
...
## 76. 业务需要实现前端项目的灰度发布，你会怎么设计？ {#question-df1eaac6-96e2-431f-be79-86b569717061}
...
## 77. 一般怎么做代码重构？ {#question-e81ec006-41fe-49da-ac71-ebe42cec6b66}
...
## **3. 代码拆分与优化**
### **✅ 提取公共逻辑**
**问题**：多个组件都在 `useEffect` 里写了相同的 API 请求<br>
**优化**：封装成 **自定义 Hook**
...
### **✅ 移除不必要的状态**
**问题**：状态滥用，例如 Redux 里存放临时 UI 状态<br>
...
## 78. 请求失败会弹出一个 toast，如何保证批量请求失败时， 只弹出一个 toast？ {#question-6f4723ca-870c-4d43-b461-5dcdcec428af}
...
## 79. 如果想将一个前端项目中的 px 全部转为 rem，你有什么思路 {#question-38103157-9bb4-4fdb-8567-d7dc4fae07e7}
...
## 80. 对于富文本编辑器中的划词交互（鼠标滑动选择一组字符， 对该组字符进行操作），你有什么实现思路？ {#question-ffa236b4-904b-4796-88b3-aa350072563a}
...
## 81. 如何在浏览器中实现 PDF 文件的预览？ {#question-4d26d285-ec10-4515-9fcd-3221ebbcaf43}
...
## 82. 做前端错误监控时，有什么办法能将报错的源码地址，包括代码行数也进行上报吗？ {#question-965b51c6-398a-4d51-978b-01ebbffd1ede}

> 难度：3.5 · 类型：QA

### 题目要点

1. **基础捕获**：利用 `error` 事件获取行列号，但生产环境代码通常被压缩<br>
2. **Source Map**：必须与构建流程结合，且需保证安全性<br>
3. **上下文增强**：通过动态获取源码片段辅助诊断<br>
4. **错误去重**：根据文件名+行号+错误类型生成唯一指纹<br>
5. **性能权衡**：Source Map 解析会增加后端处理开销<br>

**推荐方案**：
- 中小项目：直接使用 Sentry/Fundebug 等成熟方案<br>
- 大型项目：自建 Source Map 解析服务 + ELK 存储分析<br>
...
## 83. 设计一个技术方案，能在排查问题时，还原用户的操作流程 {#question-f48c83cb-8304-435a-8f1f-98e980d52658}
...
## 84. 什么是单点登录，以及如何进行实现？ {#question-20d4a56b-719b-47ba-b29b-f8a61e226958}
